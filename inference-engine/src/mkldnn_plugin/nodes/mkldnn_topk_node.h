...
private:
    ...
    inline void bitonic_push_idx(int p, int n, int *buf, int &cnt, bool cmp_val = true);
    ...
    std::shared_ptr<int> bitonic_idx_buf;
    std::shared_ptr<int> bitonic_k_idx_buf;
